...
from MLFM_GCP.partitioning.FM.FM_methods import get_all_configs, get_all_costs, calculate_full_cost
from MLFM_GCP.graphs.coarsening.coarsener import HypergraphCoarsener
import time
...
from MLFM_GCP.graphs.hypergraph_methods import get_all_costs_hetero, calculate_full_cost_hetero
...
def MLFM_blocks(graph,
    ...
    graph_list, mapping_list = coarsener.coarsen_blocks(hypergraph=graph, num_blocks=num_blocks)
    ...
    if full:
        ...
        assignment_list_c, cost_list_c, time_list_c = multilevel_FM(coarsened_hypergraphs=coarse_graph_list,
