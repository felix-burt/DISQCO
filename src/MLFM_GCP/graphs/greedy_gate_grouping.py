...
# # def group_distributable_packets_dict(layers,num_qubits,anti_diag=False):
# #     "Uses the rules for gate packing to create groups of gates which can be distributed together"
# #     new_layers = copy.deepcopy(layers)
# #     live_controls = [[] for _ in range(num_qubits)]
# #     for l, layer in enumerate(layers):
...
# #                         except IndexError as e:
# #                             print(live_controls[qubit])
# #                             start_layer = live_controls[qubit][0][2]
# #                             print(start_layer)
# #                             print(live_controls[qubit][0])
# #                             info = live_controls[qubit][0]
# #                             gate = ['cp', [info[0],info[1]], ['q','q'], info[3]]
# #                             new_layers[start_layer].append(gate)
        ...
        for i in range(len(layer)):
            ...
            if gate_type == 'single-qubit':
                ...
                if qubit1 in live_controls:
                    ...
                    num_sub_gates1 = len(group1['sub-gates'])
                else:
                    group1 = None
                    num_sub_gates1 = 0
                ...
                if qubit2 in live_controls:
                    ...
                    num_sub_gates2 = len(group2['sub-gates'])
                else:
                    group2 = None
                    num_sub_gates2 = 0
                    group2 = None
