...
def FM_pass(hypergraph,
        ...
        while h < limit:
            ...
            assignment_new, array, buckets = take_action_and_update_dict(hypergraph,node,destination,array,buckets,num_partitions,lock_dict,assignment,costs)
