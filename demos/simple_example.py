...
from disqco.scheduling.greedy_scheduler import group_commutative_gates
...
runtime, schedule = evaluate_quantum_runtime(partitioned_circuit, {'u': 1, 'cx': 2, "swap": 6, 'measure': 5, 'EPR': 100})
...
print(group_commutative_gates(circuit))